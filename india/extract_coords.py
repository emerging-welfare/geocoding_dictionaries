...
dist_unknowns = ["Jhargram", "Charaideo", "East Karbi Anglong", "West Karbi Anglong", "Purba Bardhaman", "Paschim Bardhaman", "Kalimpong", "Thodupuzha", "Hojai", "Jiribam", "Noney", "Alipurduar", "Narayanpet", "Bishwanath", "Longding", "Agar Malwa", "Tengnoupal", "Devikulam", "Peerumade", "Roorkee", "Udumbanchola", "Kangpokpi", "Sohna", "Kamjong", "Haldwani", "Phungyar", "Kakinada (Rural)", "Kakinada (Urban)", "Dhari", "Majuli", "Pherzawl", "South Salmara-Mankachar", "Rajahmundry (Urban)", "Rajahmundry (Rural)", "Tuni", "Devipatnam", "Samalkota", "Prathipadu", "Vararamachandrapuram", "Y. Ramavaram", "Kothapalle", "Charkhi Dadri"]
# ["Kakinada (Rural)", "Kakinada (Urban)", "Dhari", "Majuli", "Pherzawl", "South Salmara-Mankachar", "Rajahmundry (Urban)", "Rajahmundry (Rural)", "Tuni", "Devipatnam", "Samalkota", "Prathipadu", "Vararamachandrapuram", "Y. Ramavaram"] are towns or villages in East Godavari district.
dist_new_ones = ["Tenkasi", "Kallakurichi", "Tirupattur", "Chengalpattu", "Sholinganallur", "Ranipet", "Mulugu", "Gaurela-Pendra-Marwahi"]
national_parks = ["Manas National Park", "Bandipur National Park/Tiger Reserve", "Nallamala Forest", "Nagarahole (Rajiv Gandhi) National Park/Tiger Reserve", "Kaziranga National Park/Tiger Reserve", "Bannerghatta National Park", "Rajaji National Park/Tiger Reserve", "Kudremukh National Park", "Kalakad WLS", "Megamalai WLS", "Ranipet disrtict"]
